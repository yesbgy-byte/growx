        ...
        <div className="animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {currentDetails.map((metric) => (
              <div key={metric.id} className="bg-white p-6 rounded-2xl border border-slate-200 hover:border-orange-400 hover:shadow-lg transition-all group min-h-[220px] flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center font-bold text-sm group-hover:bg-orange-100 group-hover:text-orange-600 transition-colors">
                    {metric.id}
                  </div>
